[![Build Status](https://github.com/opspec-pkgs/jwt.encode/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/jwt.encode/actions?query=workflow%3Abuild+branch%3Amain)
